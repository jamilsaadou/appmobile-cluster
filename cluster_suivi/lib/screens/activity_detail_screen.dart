...
class _ActivityDetailScreenState extends State<ActivityDetailScreen> {
  ...
  Widget _buildBeneficiariesCard() {
    final total = _activity.hommes + _activity.femmes + _activity.jeunes;
  ...
  Widget _buildPhotoItem(String photoName, int index) {
    return Container(
      ...
      child: GestureDetector(
        ...
        child: ClipRRect( // ← CORRIGÉ: ClipRRect au lieu de ClipRRRect
          borderRadius: BorderRadius.circular(8),
          child: Container(
            width: 120,
            height: 120,
                  ...
                  return FutureBuilder<bool>(
                    ...
                    builder: (context, existsSnapshot) {
                      if (existsSnapshot.data == true) {
                        ...
                        // ✅ Afficher un placeholder pour images serveur non disponibles localement
                        return Container(
  ...
  String _getStatusDescription() {
    switch (_activity.statut) {
      case 'approuve':
        return 'Cette activité a été validée par votre superviseur';
      case 'rejete':
        return 'Cette activité a été refusée. Voir le motif ci-dessous.';
      default:
        return 'Cette activité est en attente de validation';
    }
  }

  bool _canEdit() {
    // Le conseiller peut modifier si l'activité est en attente ou refusée
    return _activity.statut == 'en_attente' || _activity.statut == 'rejete';
  }
  ...
  Future<void> _editActivity() async {
    ...
    if (result == true) {
      // Recharger l'activité après modification
  ...
  Future<void> _refreshActivity() async {
    try {
      final updatedActivity = await context
          ...
          .getActivityById(_activity.id ?? _activity.localId.hashCode);
